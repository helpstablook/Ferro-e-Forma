...
('Painel de TV Industrial', 'Painel de TV em madeira rústica e estrutura de ferro preto, ideal para salas modernas estilo loft.', 1120.00, 'image/PainelTV.png', 3, 1);
...
('Sofá Industrial', 'Sofá de dois lugares com estrutura metálica exposta e estofado em couro marrom envelhecido.', 1890.00, 'image/SofaIndustrial.png', 2, 2);
...
('Mesa de Reunião Industrial', 'Mesa ampla de reunião com pés metálicos e tampo de madeira rústica.', 1760.00, 'image/MesaReuniao.png', 1, 3);
('Escrivaninha Industrial', 'Escrivaninha com estrutura metálica e tampo em madeira. Ideal para home office.', 526.00, 'image/Escrivaninha.png', 6, 3), 
('Cadeira de Escritório Industrial', 'Cadeira com rodízios, estrutura de aço e assento estofado.', 399.00, 'image/CadeiraEscritorio.png', 7, 3);
...
('Cristaleira Industrial', 'Cristaleira com estrutura de ferro preto e portas de vidro, ideal para expor utensílios e bebidas.', 1140.00, 'image/CristaleiraIndustrial.png', 2, 4);
...
('Penteadeira Industrial', 'Penteadeira com tampo de madeira e estrutura metálica, espelho redondo com moldura de ferro.', 890.00, 'image/PenteadeiraIndustrial.png', 2, 5);
...
('Baú Industrial', 'Baú em aço preto com detalhes em madeira rústica e acabamento fosco.', 620.00, 'image/BauIndustrial.png', 5, 7);
...
('Arandela Industrial', 'Arandela de parede com estrutura metálica preta e lâmpada estilo retrô.', 270.00, 'image/ArandelaIndustrial.png', 8, 8);
